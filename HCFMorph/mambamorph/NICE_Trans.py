...
class Trans_decoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.backdim_2 = nn.Conv3d(in_channels * 4 + channel_num * 2, channel_num * 2, kernel_size=1, stride=1,
                                   padding='same')
        self.backdim_3 = nn.Conv3d(in_channels * 8 + channel_num * 4, channel_num * 4, kernel_size=1, stride=1,
                                   padding='same')
        self.backdim_4 = nn.Conv3d(in_channels * 16 + channel_num * 8, channel_num * 8, kernel_size=1, stride=1,
                                   padding='same')
