...
class ULAE(nn.Module):
    ...
    def __init__(self, in_ch, out_ch, basic_channel=16, is_train=True, imgshape=(160, 192, 160)):
        ...
        self.acc1 = Accumulative_Enhancement_1(in_ch, out_ch, self.share_weight_encoder, basic_channel=basic_channel,
                                               is_train=is_train, imgshape=imgshape)
        self.acc2 = Accumulative_Enhancement_2(in_ch, out_ch, self.share_weight_encoder, basic_channel=basic_channel,
                                               is_train=is_train, imgshape=imgshape)
        self.acc3 = Accumulative_Enhancement_3(in_ch, out_ch, self.share_weight_encoder, basic_channel=basic_channel,
                                               is_train=is_train, imgshape=imgshape)
...
if __name__ == "__main__":
    model = ULAE(2, 3, 16, True, [32, 192, 320]).cuda()
