...
class SS2D(nn.Module):
    def __init__(
        ...
        device=None,
        dtype=None,
        imgsize = (128,128,128),#(32,192,320),
        **kwargs,
    ):
...
class VSSBlock(nn.Module):
    def __init__(
        ...
        d_state: int = 16,
        imgsize: tuple[int, int, int] = (32,192,320),
        **kwargs,
    ):
        super().__init__()
        self.ln_1 = norm_layer(hidden_dim)
        self.self_attention = SS2D(d_model=hidden_dim, dropout=attn_drop_rate, d_state=d_state,imgsize=imgsize, **kwargs)
